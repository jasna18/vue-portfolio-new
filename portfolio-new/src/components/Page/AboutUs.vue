...
>
<!-- all manin wrapper  -->
<div class="container  px-4 lg:px-8 w-full lg:mx-auto py-4 md:py-6 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      <div class="text-center mb-4">
        <h2 class="text-xl md:text-3xl font-extrabold text-[#F68537] mb-2">
          About Me
        </h2>
        <p class="text-sm lg:text-md md:text-md text-gray-600 dark:text-gray-300" >
...
// import aosAnimation from '../../data/aosAnimation.js';
</script>
