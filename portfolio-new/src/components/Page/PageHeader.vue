...
<div class="w-full flex justify-between mx-auto z-50 pl-4 
  ...
  <nav 
  class="flex justify-between items-center lg:py-3 w-full" 
  :class="{'scrolled-nav' :isScrolled }">
    ...
    <ul class="font-bold"
      :class="[
        ...
        <li><a href="/" @click="closeMenu" class="font-bold" :class="darkMode ? 'text-white' : 'text-black'">Home</a></li>
